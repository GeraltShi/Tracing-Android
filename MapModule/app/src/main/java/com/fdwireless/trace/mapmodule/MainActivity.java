...
import com.fdwireless.trace.ui.MenuGroupPeople;
import com.fdwireless.trace.ui.MenuSearch;
import com.fdwireless.trace.ui.NavFriends;
import com.fdwireless.trace.ui.NavSettings;
import com.fdwireless.trace.ui.NavTeam;
import com.fdwireless.trace.ui.NavUser;
import com.fdwireless.trace.ui.NearbyActivity;
...
public class MainActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
    ...
    public AMapLocation dispLocation;
    ...
    protected void initMap(Bundle savedInstanceState)
    {
        ...
        dispClipoverlay = ClipOverlay.getInstance(getApplicationContext(),amap,player,MainActivity.this);
        loadMapConfig();
    }
    ...
    protected void drawUI() {
      ...
      //  new ImageRequest(MainActivity.this).get(imageView,"http://115.159.198.209/Tracing/img/usericon/"
      //         +userData.getId()+".jpg");
        //0222：加载图片后增加了回调
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.nearby:
                ...
                Log.e("user_data",userData.getName()+"");
                Log.e("user_data",userData.getPass()+"");
                Log.e("user_data",userData.getId()+"");
