...
import com.fdwireless.trace.mapmodule.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private my_StringRequest stringRequest =new my_StringRequest(this);
   ...
   // private ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   imageView = (ImageView) findViewById(R.id.image_view);
        ...
        circleImageView.setImageResource(R.drawable.qi);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              ...
              request.post(BASEURL,User.class,new my_CallBackListener<User>() {
                ...
                stringRequest.post(BASEURL, new my_CallBackListener() {
                    @Override
        ...
        if(isRemember){
           ...
           // imageView.setImageResource(R.drawable.qi);
            ...
            //Glide.with(LoginActivity.this).load(iconUrl).into(circleImageView);
            new ImageRequest(LoginActivity.this).get(circleImageView,"http://115.159.198.209/Tracing/img/usericon/"
                             +pref.getInt("id",0)+".jpg");
